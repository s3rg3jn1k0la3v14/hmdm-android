...
public class AdminReceiver extends DeviceAdminReceiver {
    ...
    public void onEnabled(Context context, Intent intent) {
        try { com.hmdm.launcher.DnsPolicyEnforcer.enforceDevicePolicies(context); } catch(Throwable t) { android.util.Log.e("HMDM-DNS", "HMDM-DNS-HOOK-ONENABLED", t); }
    ...
    public void onProfileProvisioningComplete(Context context, Intent intent) {
        try { com.hmdm.launcher.DnsPolicyEnforcer.enforceDevicePolicies(context); } catch(Throwable t) { android.util.Log.e("HMDM-DNS", "HMDM-DNS-HOOK-PROVISIONING", t); }
        SharedPreferences preferences = context.getApplicationContext().getSharedPreferences( Const.PREFERENCES, MODE_PRIVATE );
